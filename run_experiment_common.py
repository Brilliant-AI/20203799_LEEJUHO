...
reward_names = {
    ...
    'newfailcount': 'New Failure Count Reward',
    'newtcfail': 'New Test Case Failure Reward',
    'NAPFD': 'NAPFD Reward',
    'APHFW': 'APHFW Reward'
}
...
def exp_run_industrial_datasets(iteration, datasets=['paintcontrol', 'iofrol', 'gsdtsr']):
    ...
    reward_funs = {
        ...
        'napfd_reward': reward.napfd_reward,
        'APHFW_reward': reward.APHFW_reward,
        'new_timerank': reward.newtimerank,
        'new_tcfail': reward.newtcfail
    }
